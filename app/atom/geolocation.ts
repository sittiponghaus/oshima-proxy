...
export type LocationErrorReason =
  (typeof LocationErrorReason)[keyof typeof LocationErrorReason]
...
export type RequestLocationState =
  (typeof RequestLocationState)[keyof typeof RequestLocationState]
 ...
 */
export const requestLocationStateAtom: Atom.Writable<RequestLocationState> =
  Atom.writable(
 ...
 */
export const locationQueryOptionsAtom: Atom.Writable<LocationQueryOptions> =
  Atom.make<LocationQueryOptions>({
    enabled: false,
    retry: false,
  }).pipe(Atom.keepAlive)
 ...
 */
export const locationAtom: Atom.Atom<
  AsyncResult.AsyncResult<UserLocation | null, LocationPermissionError>
> = Atom.make(
...
function IsRequestLocationState(
  input: string | null,
): input is RequestLocationState {
